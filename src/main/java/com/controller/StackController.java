...
public class StackController {
	...
	@ApiOperation(value = "Add element to the Stack", response = Node.class, notes = "Elements are getting added to the Stack")
	@PostMapping("/StackPush")
	public String addToStack(@RequestBody Node listNode) {
